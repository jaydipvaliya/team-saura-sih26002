    ...
    >
      <div className="auth-modal-card">
        ...
        <div className="auth-modal-header">
          <div className="brand-badge" style={{ marginBottom: 6 }}>
            <div className="brand-icon" aria-hidden="true">
              SR
            </div>
            <div>
              <div className="brand-title">SauraRoute Access Gateway</div>
        ...
        <div className="auth-demo-section">
          <div className="auth-demo-label">
            ...
            <span>QUICK DEMO ACCESS (CLICK TO LOG IN)</span>
          </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          {/* Role Picker (Only shown during Registration) */}
          {mode === 'register' && (
            <div className="auth-input-group">
        ...
        <div className="auth-modal-footer">
          <span>Protected government corridor intelligence system (SIH26002).</span>
        </div>
      </div>
    </div>
  );
